...
body.push(
  ...
  ...Figure("outputs/report/screenshots/ss4_four_layers.png", "Four preprocessing layers rendered side by side with detections overlaid. Otsu keeps only the bright cell heads; CLAHE lifts the tails out of the background.", 1.0),
...
body.push(
  ...
  DataTable(["Run", "YOLOv5 imported", "cv2 threads", "Detections", "TP", "FP", "F1"], D.control2x2, [8, 18, 14, 16, 14, 14, 16]),
