...
govde.push(
  ...
  P("What this does not establish is which piece of global state the import leaves behind. The confidence threshold was also ruled out, since passing an explicit conf still shifts the result. Identifying the specific mechanism would require bisecting the YOLOv5 package imports, which was out of scope here. The finding should be read as: importing YOLOv5 is sufficient to change YOLO26 output. It is not a diagnosed root cause.", { before: 60, italics: true }),
